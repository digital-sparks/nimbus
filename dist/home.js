(() => {
  ...
  // src/home.js
  gsapWithCSS.registerPlugin(Observer2, ScrollTrigger, SplitText);
  window.Webflow ||= [];
  window.Webflow.push(() => {
    const testimonialSwiper = new Swiper(".testimonials-swiper_wrapper", {
      ...
      on: {
        ...
        slideChange: (swiper) => {
          swiper.slides[swiper.activeIndex].querySelectorAll('[animate="count"]').forEach((counter) => {
            createVerticalCounter(counter, parseInt(counter.getAttribute("val"), 10));
          });
          testimonialNavigation.slideTo(swiper.realIndex);
          testimonialNavigation.slides.forEach((slide2) => {
    ...
    const testimonialNavigation = new Swiper(".clients-swiper_wrapper", {
      ...
      on: {
        ...
        click: (swiper, event2) => {
          const clickedSlide = event2.target.closest(".clients-swiper_item");
          if (clickedSlide) {
  ...
  `;
      ...
      gsapWithCSS.set(tensStrip, { y: "-1.2em" });
      gsapWithCSS.set(onesStrip, { y: "0em" });
      const tensPosition = targetTens === 0 ? -1.2 : -targetTens * 1.2;
      const onesPosition = -targetOnes * 1.2;
      gsapWithCSS.to(tensStrip, {
        y: `${tensPosition}em`,
        duration: 1.5,
        ease: "power2.out"
      });
      gsapWithCSS.to(onesStrip, {
        y: `${onesPosition}em`,
        duration: 1.5,
        ease: "power2.out"
      });
    ...
    const sectionOneNavigation = new Swiper(".grow-swiper_wrapper", {
      ...
      on: {
        ...
        click: (swiper, event2) => {
          const clickedSlide = event2.target.closest(".grow-swiper_item");
          if (clickedSlide) {
            const clickedIndex = swiper.slides.indexOf(clickedSlide);
    ...
    const sectionOneSwiper = new Swiper(".process-swiper_wrapper", {
      ...
      on: {
        ...
        slideChange: (swiper) => {
          ...
          sectionOneNavigation.slides.forEach((slide2) => {
            slide2.classList.remove("swiper-slide-active");
          });
      ...
      if (scroller.id === "07") {
        ScrollTrigger.create({
          ...
          onEnter: () => {
            ...
            document.querySelectorAll(".process-nav_link, .process-nav_progress-wrap").forEach((item) => {
    ...
    document.fonts.ready.then(function() {
      ...
      document.querySelectorAll('[animate="title-mask"]').forEach((title) => {
        ...
        ScrollTrigger.create({
          ...
          scrub: true,
          markers: false,
          animation: gsapWithCSS.from(split.chars, { opacity: 0.2, stagger: 0.1 })
        });
      });
    });
    ...
    ScrollTrigger.create({
      ...
      once: true,
      onEnter: () => {
        document.querySelector(".testimonials-swiper_item").querySelectorAll('[animate="count"]').forEach((counter) => {
          createVerticalCounter(counter, parseInt(counter.getAttribute("val"), 10));
        });
      }
    });
    ScrollTrigger.create({
      ...
      once: true,
      onEnter: () => {
        document.querySelector(".process-swiper_item").querySelectorAll('[animate="count"]').forEach((counter) => {
          createVerticalCounter(counter, parseInt(counter.getAttribute("val"), 10));
        });
      }
    });
